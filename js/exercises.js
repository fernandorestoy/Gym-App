...
export const exercises = {
  ...
  push: [
    // === ANCHORS — always shown in every Push session (index 0–2) ===
    {
      ...
      group: "push",
      description: "Stand with feet shoulder-width apart, grip the bar just outside your shoulders, and press it from your upper chest to full lockout overhead. Keep your core braced and glutes squeezed to prevent lower-back arching. Lower the bar back to your collarbone with control. This is the foundation of shoulder and upper-body pressing strength.",
      videoId: "2yjwXTZQDDI",
  ...
  pull: [
    ...
    },
    {
      ...
      group: "pull",
      description: "Set up on a chest-supported row machine or an angled bench, plant your chest firmly against the pad, and pull the handles toward your chest. The chest support eliminates lower-back fatigue and lets you focus entirely on upper-back contraction. Squeeze your shoulder blades together hard at the top and lower with full control.",
      videoId: "WYJhfAHq0A0",
      svgKey: "remo-pecho-apoyado",
    },
    {
      id: "pull-009",
      name: "Conventional Deadlift",
      group: "pull",
      description: "Stand with the bar over your mid-foot, grip it just outside your legs, and take a deep brace. Push the floor away to initiate the lift, keeping the bar in contact with your legs the entire way up. Lock out by squeezing your glutes at the top, then lower by pushing your hips back first. The most effective compound movement for total-body pulling strength.",
      videoId: "r4MzxtBKyNE",
      svgKey: "peso-muerto",
    },
    {
  ...
  legs: [
    ...
    },
    {
      ...
      group: "legs",
      description: "Sit against a bench with a barbell across your hips and feet flat on the floor at shoulder-width. Drive through your heels to thrust your hips up until your torso is parallel to the floor, squeezing your glutes hard at the top. Lower your hips without touching the floor, then repeat. The most direct and effective exercise for maximum glute development.",
      videoId: "LM8XHLYJoYs",
    ...
    },
    {
      ...
      name: "Sumo Deadlift",
      group: "legs",
      description: "Set your feet wider than shoulder-width with toes pointing outward 45 degrees, grip the bar inside your legs, and pull to full lockout. The wide stance heavily recruits the inner thighs, glutes, and hamstrings. Keep your chest tall and drive your knees out over your toes throughout the lift.",
      videoId: "LGIS9vs65Sk",
      svgKey: "peso-muerto-sumo",
    },
    {
      id: "legs-011",
