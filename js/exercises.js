...
export const exercises = {
  ...
  pull: [
    ...
    },
    {
      ...
      name: "Face Pull",
      group: "pull",
      description: "Set a cable machine to eye height and attach a rope. Grip both ends with thumbs pointing toward you and step back until the cable is taut. Pull the rope toward your face, separating your hands at the end of the movement and finishing with your elbows flared out in a goalpost position. This movement targets the rear deltoids, external rotators, and upper traps — essential for shoulder health and posture.",
      videoId: "eIq5CB9JfKE",
      svgKey: "face-pull",
    },
    {
      ...
      group: "pull",
      subgroup: "abs",
      description: "Hang from a pull-up bar with arms fully extended and core braced. Keeping your legs straight, raise them until parallel to the floor — or higher if strength allows. Lower slowly under full control without swinging. For a progression, bring your toes all the way to the bar. This is one of the most effective bodyweight exercises for lower ab development and hip flexor strength.",
      videoId: "Pr1ieGZ5atk",
    ...
    },
    {
      ...
      group: "pull",
      subgroup: "abs",
      description: "Attach a rope to a high cable pulley. Kneel facing the machine and hold the rope at your temples. Crunch your elbows down toward your thighs, deliberately rounding your spine and contracting your abs hard at the bottom. The cable provides constant resistance through the full range of motion, allowing progressive overload that bodyweight crunches cannot match.",
      videoId: "aBd6T01PBqw",
